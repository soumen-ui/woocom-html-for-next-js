export default function RefundPolicy() {
  return (
    <div>
      <section className="fluid-block">
        <div className="container col-lg-8 mx-auto">
          <div className="card shadow-lg rounded-0">
            <div className="card-body p-5">
              <div className="display-5 mb-5 text-center">PRIVACY STATEMENT
              </div>
                <div className="mt-5 mb-3">
                  <h4> WHAT DO WE DO WITH YOUR INFORMATION?
                  </h4>
                </div>
                ...
                <p >We use Razorpay for processing payments. We/Razorpay do not store your card data on their
                  ...
                  DSS) when processing payment. Your purchase transaction data is only used as long as is necessary
                  to complete your purchase transaction. After that is complete, your purchase transaction
                ...
                <p >
                  For more insight, you may also want to read terms and conditions of Razorpay on <span><a href="https://razorpay.com">https://razorpay.com</a></span></p>
                ...
                <p >Once you leave our store&apos;s website or are redirected to a third-party website or application, you
                  are no longer governed by this Privacy Policy or our website&apos;s Terms of Service.</p>
                <div className="mt-5 mb-3">
                  <h5>LINKS</h5>
                </div>
                ...
                <p >We reserve the right to modify this privacy policy at any time, so please review it frequently.
                  ...
                  are aware of what information we collect, how we use it, and under what circumstances, if any,
                  we use and/or disclose it.
                </p>

                <p >If our store is acquired or merged with another company, your information may be transferred to
                ...
                <p >If you would like to: access, correct, amend or delete any personal information we have about
                  you, register a complaint, or simply want more information contact our Privacy Compliance Officer
                  at <span><a href="mailto:byresh@gmail.com">byresh@gmail.com</a>
                  </span>

                </p>
                <p >Address: 184, Chickpet Main Road, Bangalore - 53
